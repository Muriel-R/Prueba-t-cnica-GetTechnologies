...
namespace Sample
{
    ...
    public class FileUpdater
    {
        ...
        {
            // Dummy: en un sistema real aquí ejecutarías scripts/bats.
            // Para la prueba: solo dejamos evidencia en consola.
            Console.WriteLine($"[ExecuteBats] {Path.GetFileName(file)} ext={extension} relDir={targetRelativeDirectory}");
        }
        ...
        private void CopyFile(string sourceFile, string targetFile)
        {
            ...
            Console.WriteLine($"[CopyFile] {sourceFile} -> {targetFile}");
        }
        ...
        private void RemoveFile(string targetFile)
        {
            if (File.Exists(targetFile))
            {
                ...
                Console.WriteLine($"[RemoveFile] {targetFile}");
            }
        }
